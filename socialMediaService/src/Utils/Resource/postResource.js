...
export class PostResource {
  constructor(postDbObject) {
    this.id = postDbObject.id ? postDbObject.id : postDbObject._id;
    ...
    this.user = {
      ...
      verificationStatus: postDbObject.user.verificationStatus
        ? postDbObject.user.verificationStatus
        : "not requested",
    };
    ...
    if (this.originalPost) {
      this.originalPost.id = postDbObject.originalPost.id;
    }
  }
...
// for get profile by id posts
export class ProfilePostsResource {
  constructor(postDbObject, verificationStatus) {
    this.id = postDbObject.id ? postDbObject.id : postDbObject._id;
    this.caption = postDbObject.caption;
    this.user = {
      id: postDbObject.user._id,
      ...
      image: postDbObject.user.image
        ...
        : "public/uploads/default.png",
      isFollowing: postDbObject.user.isFollowing ? postDbObject.user.isFollowing : false,
      verificationStatus: verificationStatus ?? "not requested",
    };
    this.topReactions = postDbObject.topReactionsType;
    this.attachments =
      postDbObject.attachments && postDbObject.attachments.length
