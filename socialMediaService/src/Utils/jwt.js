...
export const verifyJWT = async (data) => {
  ...
  try {
    ...
    console.log(deviceToken, "deviceToken in req social")
    console.log(decode.payload.deviceToken, "decode.payload.deviceToken in req social")
    ...
    if (error.message !== "JWT expired") {
      return {
        error: "Social Invalid authorization token. " + error.message,
      };
    }
