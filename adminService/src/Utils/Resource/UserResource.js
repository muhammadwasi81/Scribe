export class UserResource {
  constructor(user, authToken = null, refreshToken = null) {
    // Create UserObject
    this.UserObject = {
      id: user._id,
      ...
      image: user.image
        ? user.image._doc && user.image._doc && user.image._doc.mediaUrl
          ? user.image._doc.mediaUrl.replaceAll("\\", "/")
          : user.image.mediaUrl
          ? user.image.mediaUrl.replaceAll("\\", "/")
    ...
    if (authToken && refreshToken) {
      this.UserObject.authToken = authToken;
      this.UserObject.refreshToken = refreshToken;
    }
  }
