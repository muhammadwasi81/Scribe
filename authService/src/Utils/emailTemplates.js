...
export const emailForAccountVerification = (data) => {
  ...
  return {
    ...
    html: `
      <div background = "cid:background"
        style = "display:inline-block; padding:20px 20px 40px 20px; position: relative; overflow: hidden; width: 100%; background-size: cover; background-position: center; background-repeat: no-repeat;"
      >
