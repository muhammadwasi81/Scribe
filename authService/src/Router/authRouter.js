...
AuthRouter.route("/social_onboarding").post(AuthController.SocialOnboarding);
...
AuthRouter.route("/request_account_verification").get(
  authMiddleware,
  AuthController.requestProfileVerification,
);
AuthRouter.route("/deleteAccount").delete(authMiddleware, AuthController.deleteAccount);
AuthRouter.route("/verify_authToken").get(authMiddleware, AuthController.verifyAuthToken);

// request account verification
// AuthRouter.route("/request_account_verification").post(authMiddleware, toggleRequestVerification);
